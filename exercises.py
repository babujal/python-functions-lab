...
def convert_temperature (temperature, unit):
    if unit.lower() == ('c'):
        ...
        print(f'You provided {unit} for unit, please provide F or C')

print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temperature(0, 'C'))
print('Exercise 4: Convert 32°F to Celsius:', convert_temperature(32, 'F'))
convert_temperature(32, 'Y')
# ///////////////////////////////////
...
def sum_to (n):
    exclusive = n + 1
    for number in range(1, exclusive):
        print (number)

print('Exercise 5:', sum_to(8))
sum_to(8)
# //////////////////////////////////
...
def largest (int1, int2, int3):
    ...
    if int1 < int2:
        the_bigest_num = int2
    if int3 > the_bigest_num:
        the_bigest_num = int3
    return the_bigest_num           

print('Exercise 6:', largest(1, 3, 2))
# ///////////////////////////////////
...
def calculate_tip (bill, bill_percentage):
    tip_amount = (bill_percentage / 100) * bill
